export const mensajes = [
  ...
  },
  {
    ...
    message: {
      ...
      type: "text",
      text: "¡Bienvenido a Barbs Company! En que te puedo ayudar|[Soporte 👩‍💻]|[Ventas 🛍]|[❌ Cancelar]",
...
export const mensajes2 = [
  ...
  export const  getClientId = (messages) => {
      const firstClientMessage =(messages).find(
        (message) => message.message.typeUser === "Client"
      );
      return firstClientMessage ? firstClientMessage.client : null;
  }
